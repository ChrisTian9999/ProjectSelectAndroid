...
import com.chris.pss.library.rxpermissions.RxPermissions;
...
public class PhoneUtils {
     ...
     * 直接拨打电话
     */
    public static void intentToCall(final Activity context, final String phoneNumber) {
        ...
        if(DeviceUtils.getSDK() >= 23){
            ...
            new RxPermissions(context).request(Manifest.permission.CALL_PHONE).subscribe(new Action1<Boolean>() {
                @Override
    ...
    private static void toCall(final Context context, final String phoneNumber){
        Intent intent = new Intent();
